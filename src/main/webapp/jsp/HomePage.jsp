    ...
    <div class="container" id="vehicles">
      ...
      <div class="vehicles">
        ...
        <div class="vehicle-card">
          ...
          <button onclick="window.location.href='Vehicles.jsp'">View Cars</button>
        </div>
        ...
        <div class="vehicle-card">
          ...
          <button onclick="window.location.href='Vehicles.jsp'">
            View Motor Bikes
          </button>
        </div>
        ...
        <div class="vehicle-card">
          ...
          <button onclick="window.location.href='Vehicles.jsp'">View Vans</button>
        </div>
        ...
        <div class="vehicle-card">
          ...
          <button onclick="window.location.href='Vehicles.jsp'">View SUVs</button>
        </div>
      </div>
    </div>
